...
-s returns only the result converted back into digits, while -a plays a jank animation. Animation is total shit rn and skips carrying so just looks like cheating.
## Fun
