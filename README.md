...
cd abacus<br />
gcc -c ablib.c -o ablib.o && ar rcs ablib.a ablib.o && gcc interactive.c ablib.a -g -o abacus
## Usage
You can run it with no arguments which will prompt you to give numbers. It also takes arguments of two numbers, and as of rn two flags: -s & -a. (-a is not currently implemented)<br />
